...
- Crea la clase de la acción en el paquete `com.uam.bfa.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.uam.bfa.acciones.MostrarImporte"/>
</controlador>
```

```java
package com.uam.bfa.acciones;
...
- ✅ Coloca las clases de acción en `com.uam.bfa.acciones`
...
- Crea un paquete `cuadrosmando` (ej. `com.uam.bfa.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
